...
function addProductToCart(button) {
    ...
    const productPrice = document.getElementById('product-price-' + productId).innerText.replace('$', '');
    const productImage = document.getElementById('ProductImg-' + productId).src;
